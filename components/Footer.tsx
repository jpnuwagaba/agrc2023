...
const Footer = () => {
  return (
    <div className='mt-16 bg-gray-100 py-24'>
      <div className="w-[90%] mx-auto flex flex-col justify-between gap-6 flex-reverse items-center md:flex-row md:w-[80%]">
        <div>
          ...
          <div className="flex gap-6 my-6 items-center">
            ...
            <BsTwitter size={'1.4em'} color={'darkRed'} />
            <AiFillYoutube size={'1.4em'} color={'darkRed'} />
            <FaLinkedinIn size={'1.4em'} color={'darkRed'} />
          </div>
          <div className="bg-darkGreen text-center text-white p-2 rounded-lg mb-3">agrc@cedat.mak.ac.ug</div>
          <div className="bg-darkGreen text-center text-white p-2 rounded-lg mb-3">+256 781147096</div>
        </div>
        <div>
